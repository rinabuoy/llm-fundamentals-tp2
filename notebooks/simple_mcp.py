...
if __name__ == "__main__":
    # HTTP transport: the server stays up as one persistent process at this URL,
    # so any number of clients (this notebook, restarted cells, etc.) can connect
    # to the same running instance instead of each spawning their own subprocess.
